...
class TestBlockToBlockType(unittest.TestCase):
    ...
    def test_html_block(self):
        self.assertEqual(block_to_block_type("<details><summary>Projects</summary><p>stuff</p></details>"), BlockType.HTML)

    def test_html_multiline_block(self):
        block = "<details>\n<summary>Projects</summary>\n<p>stuff</p>\n</details>"
        self.assertEqual(block_to_block_type(block), BlockType.HTML)

    def test_html_closing_tag_block(self):
        self.assertEqual(block_to_block_type("</div>"), BlockType.HTML)

    def test_not_html_angle_bracket_text(self):
        self.assertEqual(block_to_block_type("< this is not html"), BlockType.PARAGRAPH)
